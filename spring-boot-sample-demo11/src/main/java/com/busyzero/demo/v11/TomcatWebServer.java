...
public class TomcatWebServer implements WebServer {
    ...
    private static final Log logger = LogFactory.getLog(org.springframework.boot.web.embedded.tomcat.TomcatWebServer.class);
    ...
    private void startDaemonAwaitThread() {
        Thread awaitThread = new Thread("container-" + (containerCounter.get())) {
            ...
            @Override
            public void run() {
                org.springframework.boot.web.embedded.tomcat.TomcatWebServer.this.tomcat.getServer().await();
            }
    ...
    public void start() throws WebServerException {
        synchronized (this.monitor) {
            ...
            try {
                ...
                this.started = true;
                org.springframework.boot.web.embedded.tomcat.TomcatWebServer.logger
    ...
    private void stopProtocolHandler(Connector connector) {
        try {
            ...
            org.springframework.boot.web.embedded.tomcat.TomcatWebServer.logger.error("Cannot pause connector: ", ex);
        }
    }
    ...
    private void performDeferredLoadOnStartup() {
        try {
            ...
            org.springframework.boot.web.embedded.tomcat.TomcatWebServer.logger.error("Cannot start connector: ", ex);
